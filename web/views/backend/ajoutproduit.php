...
<body>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              ...
              <hr>
              <form method="POST" enctype="multipart/form-data" class="form-horizontal form-material" action="ajoutp.php">
                  <div class="form-group">
                    <div class="col-xs-12">
                      <label>nom</label>
                      <input type="text" name="nom" id="nom" placeholder="entrez le nom de votre produit" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                      <div class="col-xs-12">
                <label>Auteur</label>
                <input type="text" name="auteur" id="auteur" placeholder="entrez le nom de l'auteur" class="form-control">
                  </div>
                    </div>
                    <div class="form-group">
                            <div class="col-xs-12">
                <label>prix</label>
                <input type="number" name="prix" id="prix" placeholder="entrez le prix" class="form-control">
                </div>
              </div>
              <div class="form-group">
                            <div class="col-xs-12">
                <label>description</label>
                <input type="text" name="description" id="description" placeholder="entrez la description" class="form-control">
                </div>
              </div>
              <div class="form-group">
                            <div class="col-xs-12">
                <label>quantité</label>
                <input type="number" name="stock" id="stock" placeholder="entrez la quantité" class="form-control">
               </div>
             </div>
             <div class="form-group">
                            <div class="col-xs-12">
  ...
  <script type="text/javascript">
    $(document).on('keypress', '#auteur', function (event) {
    var regex = new RegExp("^[a-zA-Z ]+$");
    var key = String.fromCharCode(!event.charCode ? event.which : event.charCode);
    if (!regex.test(key)) {
        event.preventDefault();
  ...
  <script type="text/javascript">
    $(document).on('keypress', '#prix', function (event) {
  ...
  <script type="text/javascript">
    $(document).on('keypress', '#stock', function (event) {
    var regex = new RegExp("^[0-9 ]+$");
    var key = String.fromCharCode(!event.charCode ? event.which : event.charCode);
    if (!regex.test(key)) {
        event.preventDefault();
