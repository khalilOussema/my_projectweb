...
$req="SELECT * FROM `categorie` ORDER BY `categorie`.`nom` ASC";
$req2="SELECT * FROM `categorie` ORDER BY `categorie`.`nom` DESC";
if(isset($_POST['tri']))
{
  $list=$db->query($req);
}
...
else $list=$db->query("SELECT * FROM `categorie`");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              ...
              <h4><i class="fa fa-angle-right"></i> La liste des catégories</h4>
              <hr>
              <table class="table">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="deletecategorie.php?id=<?php echo $row['id'];?>"><i class="fa fa-trash-o "></a></td>
                    <td><a href="modifiercategorie.php?id=<?php echo $row['id'];?>"><i class="fa fa-pencil"></i></a></td>
                  </tr>
<?php
                }
                  ?>
