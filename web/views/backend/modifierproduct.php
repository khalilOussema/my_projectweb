...
$liste=$db->query($req);
$id=$_GET['id'];
$req12="SELECT * from produit WHERE id='$id'";
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              ...
              <hr>
              <form method="POST" enctype="multipart/form-data" class="form-horizontal form-material" action="modprod.php">
                ...
                <input type="text" name="auteur" id="auteur" value="<?php echo $auteur;?>" class="form-control">
                  </div>
                    </div>
                    <div class="form-group">
                            <div class="col-xs-12">
                <label>prix</label>
                <input type="number" name="prix" id="prix" value="<?php echo $prix;?>" class="form-control">
                </div>
              </div>
              <div class="form-group">
                            <div class="col-xs-12">
              ...
              <div class="form-group">
                ...
                <input type="number" name="stock" id="stock" value="<?php echo $quantite;?>" class="form-control">
               </div>
             </div>
                  <div class="form-group">
                            <div class="col-xs-12">
